...
export interface ApiMatchMatch extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Fixtures and results connected to teams.';
    displayName: 'Match';
    pluralName: 'matches';
    singularName: 'match';
  };
  ...
  attributes: {
    ...
    matchType: Schema.Attribute.Enumeration<['home', 'away', 'neutral']> &
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Club news articles and editorial football stories.';
    displayName: 'News';
  ...
  attributes: {
    author: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041F\u0440\u0435\u0441-\u0441\u043B\u0443\u0436\u0431\u0430 \u043A\u043B\u0443\u0431\u0443'>;
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'\u041A\u043B\u0443\u0431'>;
...
export interface ApiPlayerPlayer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Squad players linked to a team.';
    displayName: 'Player';
    pluralName: 'players';
    singularName: 'player';
  };
  ...
  attributes: {
    age: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    captain: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    nationality: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0423\u043A\u0440\u0430\u0457\u043D\u0430'>;
    ...
    > &
      Schema.Attribute.Required;
    preferredFoot: Schema.Attribute.Enumeration<
      [
        '\u041F\u0440\u0430\u0432\u0430',
        '\u041B\u0456\u0432\u0430',
        '\u041E\u0431\u0438\u0434\u0432\u0456',
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global, editable website settings (singleton).';
  ...
  attributes: {
    clubName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u0424\u041A \u0412\u0438\u0448\u043D\u0435\u0432\u0435'>;
    contacts: Schema.Attribute.Component<'shared.contact-info', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiStaffStaff extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Coaching and club staff.';
    displayName: 'Staff';
    pluralName: 'staffs';
    singularName: 'staff';
  };
  ...
  attributes: {
    ...
    socials: Schema.Attribute.Component<'shared.social-links', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTeamTeam extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Club teams (first team, youth, U-19, etc.).';
    displayName: 'Team';
    pluralName: 'teams';
    singularName: 'team';
  };
  ...
  attributes: {
    ...
    primaryColor: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#a71f45'>;
    publishedAt: Schema.Attribute.DateTime;
    secondaryColor: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'#070709'>;
